...
> sum of a product’s attributes, its name, pack- aging, and price, its history,
...
> the prod- uct entirely, taking on an “enchanting, some- times religious
> character,” adding a “spiritual dimension to what used to be ‘merely a prod-
> uct’” (Askegard 2006, p. 96).
...
particularly clever [speech act](). Indeed the [Copenhagen
