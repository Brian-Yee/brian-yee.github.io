...
estimation](https://en.wikipedia.org/wiki/Kernel_(statistics)) (KDE).
...
<p align="center">
    <a href="https://en.wikipedia.org/wiki/Kernel_(statistics)">
        <img width="460" height="300" src="../images/triathlon/kernel.png">
    </a>
</p>
