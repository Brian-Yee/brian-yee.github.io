...
Python and iterm doesn't render all the emojis so for instructive purposes I have copy-pasted those
corresponding emojis here. Even without them displayed, the majority are displayed allowing us to
yield surprisingly useful results and better yet some that I would not of traditionally thought of.
For example burger shows up in "avocado" because in Mexico avocado is a popular topping of burgers
and samurai shows "cool" glasses because of a slang term in Japan. Due to an excessive amount of
word play in my titles passing the full string don't usually yield the best results. However I can
